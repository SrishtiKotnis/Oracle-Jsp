...
<html>
    ...
    <body>
      <div class="back">
       ...
       ResultSet rs =st.executeQuery("SELECT desc2 FROM MASTERS WHERE group1='06' and group2='04' ");
         ResultSetMetaData rsm = rs.getMetaData();
         
        Statement st1=conn.createStatement();
        ResultSet rs1 =st1.executeQuery("SELECT group2,PARAM_CODE,PARAM_DESC FROM MASTERS WHERE group1='06' AND GROUP2='04' order BY param_code ");
    ...
    <table border="5px">
                          ...
                          <tr>
                             ...
                             <form action="ajobs.jsp" method="post">      
<%
